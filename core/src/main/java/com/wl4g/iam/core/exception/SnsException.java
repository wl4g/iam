...
public class SnsException extends Oauth2Exception {
     ...
     */
    public SnsException(String provider) {
     ...
     */
    public SnsException(String provider, String message) {
        super(message);
     ...
     * @since 1.4
     */
    public SnsException(String provider, String message, Throwable cause) {
        super(message, cause);
        hasTextOf(provider, "provider");
        this.provider = provider;
    }
     ...
     * @since 1.4
     */
    public SnsException(String provider, Throwable cause) {
        super(cause);
        hasTextOf(provider, "provider");
        this.provider = provider;
    }
