 ...
 */
package com.wl4g.iam.example.web;
...
public class ExampleController {
    ...
    public String indexView(HttpServletRequest request, HttpServletResponse response) {
        ...
        String exampleKey1 = (String) SecurityUtils.getSubject().getSession().getAttribute(
                ExampleClientSecurityCoprocessor.KEY_EXAMPLE_STORE_IN_SESSION);
