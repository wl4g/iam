...
public abstract class IamFlinkStreamingBase implements Runnable {
     ...
     * @return
     */
    protected abstract IamFlinkStreamingBase customStream(DataStreamSource<IamEventAnalyticalModel> dataStream);
    ...
    public void run() {
        ...
        DataStreamSource<IamEventAnalyticalModel> dataStream = env.fromSource(createSource(),
