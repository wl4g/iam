 ...
 * @since 3.0.0
 */
public final class NoneSecureCryptService extends AbstractAymmetricSecureCryptService<RSAKeyPairSpec> {

    public NoneSecureCryptService(JedisLockManager lockManager) {
        super(lockManager, new RSACryptor());
    }

    @Override
    public CryptKind kind() {
        return CryptKind.NONE;
    }
