...
import com.wl4g.iam.sns.wechat.model.WxBasedAccessToken;
 ...
 * @since
 */
public abstract class AbstractWechatOauth2Template<C extends AbstractSocialProperties, T extends WxBasedAccessToken, O extends WxBasedOpenId, U extends Oauth2UserProfile>
    ...
    public AbstractWechatOauth2Template(C config, RestTemplate restTemplate, CacheManager cacheManager) {
