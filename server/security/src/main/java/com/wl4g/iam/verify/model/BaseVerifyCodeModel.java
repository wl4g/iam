 ...
 * @since
 */
public abstract class BaseVerifyCodeModel implements Serializable {
    ...
    public BaseVerifyCodeModel() {
        super();
    }

    public BaseVerifyCodeModel(@NotBlank String applyToken, @NotBlank String verifyType) {
