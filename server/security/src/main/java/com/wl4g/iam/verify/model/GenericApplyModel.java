 ...
 * @since
 */
public class GenericApplyModel extends BaseVerifyCodeModel {
    private static final long serialVersionUID = -5065908011134214117L;

    @NotBlank
    private String primaryImg;

    public GenericApplyModel() {
        super();
    }

    public GenericApplyModel(@NotBlank String applyToken, @NotBlank String verifyType) {
