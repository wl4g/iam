 ...
 */
package com.wl4g.iam.web.jssdk;
 ...
 * @since
 */
public class JssdkWebResourceController extends SimpleEmbedWebappEndpoint {

    public JssdkWebResourceController(SimpleEmbedWebappProperties config) {
        super(config);
    }
