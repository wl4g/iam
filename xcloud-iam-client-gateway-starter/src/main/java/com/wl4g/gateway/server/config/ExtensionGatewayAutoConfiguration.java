...
import com.wl4g.gateway.server.authc.TmpStandardApiAuthenticaingFilter;
import com.wl4g.gateway.server.ratelimit.HostAddrKeyResolver;
import com.wl4g.gateway.server.ratelimit.UriKeyResolver;
 ...
 */
@Configuration
public class ExtensionGatewayAutoConfiguration {
    ...
    @Bean
    public TmpStandardApiAuthenticaingFilter tmpStandardApiAuthenticaingFilter() {
        return new TmpStandardApiAuthenticaingFilter();
    }
