...
public class GenericAuthenticationInfo extends AbstractIamAuthenticationInfo {
	...
	public GenericAuthenticationInfo(IamPrincipal accountInfo, PrincipalCollection principals, String realmName) {
		this(accountInfo, principals, null, realmName);
	}

	public GenericAuthenticationInfo(IamPrincipal accountInfo, PrincipalCollection principals, ByteSource credentialsSalt,
			String realmName) {
