...
failedText:Common.Util.isZhCN()?"再试一次":"Let's try again?",barText:Common.Util.isZhCN()?"请拖动滑块完成拼图":"Drag to complete the jigsaw",repeatIcon:"fa fa-repeat",getApplyCaptchaUrl:null,getVerifyAnalysisUrl:null,verifyDataKey:"verifyData",applyCaptcha:function(a,c,b){var h=this,f=Common.Util.checkEmpty("options.getApplyCaptchaUrl",h.getApplyCaptchaUrl()),t=f.substring(0,f.lastIndexOf("?"));d.ajax({url:t,type:"post",data:Common.Util.toUrl({},Common.Util.toUrlQueryParam(f)),xhrFields:{withCredentials:!0},
