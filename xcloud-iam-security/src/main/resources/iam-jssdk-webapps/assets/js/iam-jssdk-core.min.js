...
a)})};IAMCore.prototype.getUMToken=function(){return this.runtime.umid.getValue()};IAMCore.prototype.safeCheck=function(a,b,c){this._initHandshakeIfNecessary(c).then(function(c){_initSafeCheck(a,b)});return this};IAMCore.prototype.anyAuthenticators=function(){return this.accountAuthenticator().smsAuthenticator().snsAuthenticator().captchaVerifier()};IAMCore.prototype.accountAuthenticator=function(){this.settings.account.enable=!0;return this};IAMCore.prototype.smsAuthenticator=function(){this.settings.sms.enable=
