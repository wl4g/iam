(function(n,p){var m={iamVerboseStoredKey:"__IAM_VERBOSE",umidTokenStorageKey:"__IAM_UMIDTOKEN",authRedirectRecordStorageKey:"__IAM_AUTHC_REDIRECT_RECORD",useSecureAlgorithmName:"RSA"};n.IAMCore=function(a){var b=this;this.getIamBaseUri=function(){var a=location.protocol,d=location.hostname,e=b.settings.deploy.defaultServerPort,f=b.settings.deploy.defaultTwoDomain,g=b.settings.deploy.defaultContextPath,g=g.startsWith("/")?g:"/"+g;if(Common.Util.isIp(d)||"localhost"==d||"127.0.0.1"==d||d.endsWith(".debug")||
d.endsWith(".local")||d.endsWith(".dev"))return a+"//"+d+":"+e+g;d=Common.Util.extTopDomainString(d);return a+"//"+f+"."+d+g};this.runtime={umid:{_value:null,getValue:function(){return Common.Util.checkEmpty("Fatal error, umidToken value is null, No attention to call order (must be executed after that.runtime.umid.getValuePromise())",b.runtime.umid._value)},_currentlyInGettingValuePromise:null,getValuePromise:function(){if(b.runtime.umid._currentlyInGettingValuePromise)return b.runtime.umid._currentlyInGettingValuePromise;
var a=Common.Util.Codec.decodeBase58(sessionStorage.getItem(m.umidTokenStorageKey));return Common.Util.isEmpty(a)?b.runtime.umid._currentlyInGettingValuePromise=new Promise(function(a,c){IamFingerprint.getFingerprint({},function(d){var e=new Map;e.set("userAgent",d.components.get("userAgent"));e.set("platform",d.components.get("platform"));e.set("pixelRatio",d.components.get("pixelRatio"));e.set("timezone",d.components.get("timezone"));e.set("language",d.components.get("language"));e.set("cpuClass",
d.components.get("cpuClass"));e.set("touchSupport",d.components.get("touchSupport"));e.set("deviceMemory",d.components.get("deviceMemory"));e.set("availableScreenResolution",d.components.get("availableScreenResolution"));e.set("canvas",CryptoJS.MD5(d.components.get("canvas")).toString(CryptoJS.enc.Hex));e.set("webgl",CryptoJS.MD5(d.components.get("webgl")).toString(CryptoJS.enc.Hex));e.set("indexedDb",d.components.get("indexedDb"));e.set("sessionStorage",d.components.get("sessionStorage"));e.set("localStorage",
d.components.get("localStorage"));e.set("colorDepth",d.components.get("colorDepth"));d=new Map;for(var f=Common.Util.toUrl({},e),e=100+parseInt(100*Math.random()),l=parseInt(e%3+1),h=0;h<l;h++)f=Common.Util.Codec.encodeBase58(f);f=e+"!"+f;IAMCore.Console.debug("Generated apply umidToken data: "+f);d.set("umdata",f);b._doIamRequest("post","{applyUmTokenUri}",d,function(c){Common.Util.checkEmpty("init.onPostUmidToken",b.settings.init.onPostUmidToken)(c);var d=Common.Util.checkEmpty("definition.codeOkValue",
b.settings.definition.codeOkValue);Common.Util.isEmpty(c)||c.code!=d||(IAMCore.Console.debug("Got umidToken: "+c.data.umidToken),d=Common.Util.Codec.encodeBase58(c.data.umidToken),sessionStorage.setItem(m.umidTokenStorageKey,d),a(c.data.umidToken),b.runtime.umid._value=c.data.umidToken);b.runtime.umid._currentlyInGettingValuePromise=null},function(a){b.runtime.umid._currentlyInGettingValuePromise=null;console.warn("Failed to gets umidToken, "+a);Common.Util.checkEmpty("init.onError",b.settings.init.onError)(a);
...
panel:null,img:null,input:null,getVerifier:function(){var a=Common.Util.checkEmpty("captcha.use",b.settings.captcha.use),d=Common.Util.checkEmpty("captcha.registry",b.settings.captcha.registry),e;for(e in d)if(e==a)return d[e];throw"Illegal verifier type for '"+e+"'";},registry:{VerifyWithSimpleGraph:b._defaultCaptchaVerifier,VerifyWithGifGraph:b._defaultCaptchaVerifier,VerifyWithJigsawGraph:{captchaDestroy:function(a){var c=Common.Util.checkEmpty("captcha.panel",b.settings.captcha.panel);a&&$(c).css({display:"none"})},
captchaRender:function(){b.runtime.flags.isCurrentlyApplying=!1;var a=Common.Util.checkEmpty("captcha.panel",b.settings.captcha.panel);$(a).JigsawIamCaptcha(b,{verifyDataKey:Common.Util.checkEmpty("definition.verifyDataKey",b.settings.definition.verifyDataKey),getApplyCaptchaUrl:b._getApplyCaptchaUrl,getVerifyAnalysisUrl:b._getVerifyAnalysisUrl,repeatIcon:"fa fa-redo",onSuccess:function(a){IAMCore.Console.debug("Jigsaw captcha verify successful. verifiedToken is '"+a+"'");b.runtime.flags.isCurrentlyApplying=
!1;b.runtime.verifiedModel.verifiedToken=a;Common.Util.checkEmpty("captcha.onSuccess",b.settings.captcha.onSuccess)(a)},onFail:function(a){IAMCore.Console.debug("Failed to jigsaw captcha verify. element \x3d\x3e "+a);b.runtime.flags.isCurrentlyApplying=!1;b.runtime.verifiedModel.verifiedToken="";Common.Util.checkEmpty("captcha.onError",b.settings.captcha.onError)(a)}})}}},onSuccess:function(a){IAMCore.Console.debug("Jigsaw captcha verify successfully. verifiedToken is '"+a+"'")},onError:function(a){console.error("Failed to jigsaw captcha verify. "+
...
b){IAMCore.Console.log("Prepare to submit SMS login request. mobileNum\x3d"+a+", smsCode\x3d"+b);return!0},onSuccess:function(a){IAMCore.Console.log("SMS success. "+a.message)},onError:function(a){throw"SMS login error. "+a;}},sns:{enable:!1,required:{getWhich:function(a,b){throw"Unsupported errors, please implement to support get which function";},refreshUrl:null},getPrincipal:function(){},qrcodePanel:null,pagePanel:null,provider:null,onBefore:function(a,b,e){}}};this._initConfigure(a)};n.IAMCore.Console=
{_isVerbose:function(){var a=sessionStorage.getItem(m.iamVerboseStoredKey);return a?(a=a.toUpperCase(),"TRUE"==a||"1"==a||"Y"==a||"YES"==a):!1},_doLog:function(a,b){if(IAMCore.Console._isVerbose()){var c=(new Date).format("[yyyy-MM-dd hh:mm:ss.S]")+" "+a+" --- ",d=[];d.push(c);for(var e in b)d.push(b[e]);switch(a){case "TRACE":console.trace.apply(console,d);break;case "DEBUG":console.debug.apply(console,d);break;case "INFO":console.info.apply(console,d);break;case "WARN":console.warn.apply(console,
d);break;case "ERROR":console.error.apply(console,d);break;default:console.log.apply(console,d)}}},trace:function(){IAMCore.Console._doLog("TRACE",arguments)},debug:function(){IAMCore.Console._doLog("DEBUG",arguments)},info:function(){IAMCore.Console._doLog("INFO",arguments)},warn:function(){IAMCore.Console._doLog("WARN",arguments)},error:function(){IAMCore.Console._doLog("ERROR",arguments)},log:function(){IAMCore.Console._doLog("INFO",arguments)}};IAMCore.prototype._initConfigure=function(a){a!==
this.settings&&(this.settings=$.extend(!0,this.settings,a),IAMCore.Console.debug("Merged IAM core settings: ",this.settings),this.settings.deploy.baseUri=this.getIamBaseUri(),IAMCore.Console.info("Use overlay IAM baseUri: ",this.settings.deploy.baseUri))};IAMCore.prototype.checkRespUnauthenticated=function(a){if(a){var b=a.status&&a.status==this.settings.definition.statusUnauthenticatedValue;return a.code&&(a.code==this.settings.definition.code401Value||a.code+""==this.settings.definition.code401Value)||
b}return!1};IAMCore.prototype.checkRespSuccess=function(a){return a.code==this.settings.definition.code401Value||a.code+""==this.settings.definition.code401Value?!0:!1};IAMCore.prototype._multiModularAuthenticatingHandler=function(){var a=this;return{isRedirectingLogin:!1,mutexControllerManager:new Map,doMultiModularRequest:function(b,c,d,e,f,g){a._doIamRequest(b,"@"+c,d||{},e,f,g,!1)},checkTGCExpiredAndRedirectToLogin:function(b,c){var d=a._multiModularAuthenticatingHandler();IAMCore.Console.debug("TGC validating... res: ",
b);return a.checkRespUnauthenticated(b)&&b.data&&"IamWithCasAppServer"==b.data.serviceRole?(IAMCore.Console.info("TGC expired, redirectTo: ",b.data[a.settings.definition.redirectUrlKey],"isRedirectingLogin: ",d.isRedirectingLogin),c&&!d.isRedirectingLogin&&(d.isRedirectingLogin=!0,c(b)),!0):!1},getMutexController:function(b){var c=a._multiModularAuthenticatingHandler(),d=null;b.toUpperCase().startsWith("HTTP://")?(b=new URL(b),d=b.protocol+"://"+b.host):d=location.origin+"//"+b;var e=c.mutexControllerManager.get(d);
e||c.mutexControllerManager.set(d,e={_cache_auth_state:{state:!1,time:0},urlSame:d,currentlyInAuthenticatingState:!1,requestQueue:[],authenticated:function(a){var b=e._cache_auth_state;if(a)b.state=a,b.time=(new Date).getTime();else return b.state&&1E4>Math.abs((new Date).getTime()-b.time)}});return e},doHandle:function(b,c,d,e,f,g,k){var l=a._multiModularAuthenticatingHandler();Common.Util.checkEmpty("multiModularAuthenticatingRequest.res",b);Common.Util.checkEmpty("multiModularAuthenticatingRequest.method",
c);Common.Util.checkEmpty("multiModularAuthenticatingRequest.url",d);Common.Util.checkEmpty("multiModularAuthenticatingRequest.redirectFn",k);if(a.checkRespUnauthenticated(b)){var h=l.getMutexController(d);if(h.currentlyInAuthenticatingState){var q={res:b,method:c,url:d,successFn:e,errorFn:f,params:g};h.requestQueue.push(q);IAMCore.Console.info("Offered authenticating authRequest: ",q,", requestQueue: ",h.requestQueue)}else h.currentlyInAuthenticatingState=!0,(new Promise(function(a,d){IAMCore.Console.info("Biz unauth response: ",
b);h.authenticated()?a():l.checkTGCExpiredAndRedirectToLogin(b,k)||(b.data&&b.data.redirect_url?l.doMultiModularRequest(c,b.data.redirect_url,null,a,f,null):f(b))})).then(function(a){IAMCore.Console.info("Iam-server response: ",a);if(!h.authenticated()&&!l.checkTGCExpiredAndRedirectToLogin(a,k)){if(a.data&&a.data.redirect_url)return new Promise(function(b,c){l.doMultiModularRequest("get",a.data.redirect_url,null,b,f,null)});f&&f(a)}}).then(function(b){IAMCore.Console.info("Iam-client response: ",
b);h.currentlyInAuthenticatingState=!1;l.doMultiModularRequest(c,d,g,function(b){IAMCore.Console.info("Redirect origin biz response: ",b);a.checkRespUnauthenticated(b)?h.authenticated(!1):(e&&e(b),h.authenticated(!0))},function(a){f?f(a):IAMCore.Console.error(a)},function(){if(0<h.requestQueue.length){var a=h.requestQueue[0];h.requestQueue.splice(0,1);IAMCore.Console.info("Poll authenticating queue first: ",a,", requestQueue: ",h.requestQueue);l.doHandle(a.res,a.method,a.url,a.successFn,a.errorFn,
a.params,k)}})})}else IAMCore.Console.debug("Ignore authenticated of url: ",d,", res: ",b)}}};IAMCore.prototype.getXsrfToken=function(a){var b=Common.Util.checkEmpty("definition.xsrfTokenHeaderKey",this.settings.definition.xsrfTokenHeaderKey),c=Common.Util.checkEmpty("definition.xsrfTokenParamKey",this.settings.definition.xsrfTokenParamKey),d=function(a,b,c){a={headerName:a,paramName:b,value:c};IAMCore.Console.debug("Got xsrfToken:",a);return a},e=location.hostname,f=Common.Util.extTopDomainString(e),
g=e,f=e.indexOf(f);0<f&&(g=e.substring(0,f-1));var g=g.replace(".","_").toUpperCase(),k="IAM-"+g+"-XSRF-TOKEN",l=Common.Util.getCookie(k,null);IAMCore.Console.debug("Loaded cache xsrfTokenValue:",l,"by cookieName:",k);var h=!a;l||(IAMCore.Console.debug("Loading new xsrf token..."),e=(new IAMCore(this.settings)).getIamBaseUri()+Common.Util.checkEmpty("definition.applyXsrfTokenUrlKey",this.settings.definition.applyXsrfTokenUrlKey),Common.Util.Http.request({url:e,type:"HEAD",async:!h,xhrFields:{withCredentials:!0},
success:function(e,f,g){l=Common.Util.getCookie(k);IAMCore.Console.info("Loaded new xsrfTokenValue:",l,"by cookieName:",k);h||a(d(b,c,l))},error:function(a,b,c){IAMCore.Console.error("Failed to init xsrf token. "+c)}}));if(h)return d(b,c,Common.Util.getCookie(k))};IAMCore.prototype.generateReplayToken=function(){for(var a=(new Date).getTime(),b="",c=0;2>c;c++)b+=Math.random().toString(36).substr(2);for(var c=Common.Util.sortWithAscii(b+a),d=Common.Util.Crc16CheckSum.crc16Modbus(c),d=parseInt(d%c.length/
Math.PI)+1,e=c,c=0;c<d;c++)e=CryptoJS.MD5(e).toString(CryptoJS.enc.Hex);c=JSON.stringify({n:b,t:a,s:e});a=Common.Util.checkEmpty("definition.replayTokenHeaderKey",this.settings.definition.replayTokenHeaderKey);b=Common.Util.checkEmpty("definition.replayTokenParamKey",this.settings.definition.replayTokenParamKey);d=Common.Util.Codec.encodeBase58(c);IAMCore.Console.debug("Generated replay token(plain): ",c," - ",d);return{headerName:a,paramName:b,value:d}};IAMCore.prototype._getSnsConnectUrl=function(a,
b){var c=Common.Util.checkEmpty("sns.required",this.settings.sns.required),c=Common.Util.checkEmpty("required.getWhich",c.getWhich(a,b));a=this.settings.deploy.baseUri+Common.Util.checkEmpty("definition.snsConnectUri",this.settings.definition.snsConnectUri)+Common.Util.checkEmpty("provider",a)+"?"+Common.Util.checkEmpty("definition.whichKey",this.settings.definition.whichKey)+"\x3d"+c;if("bind"==c.toLowerCase()||"unbind"==c.toLowerCase()){var c=encodeURIComponent(Common.Util.checkEmpty("sns.principal",
this.settings.sns.getPrincipal())),d=encodeURIComponent(Common.Util.checkEmpty("sns.required.refreshUrl",this.settings.sns.required.refreshUrl));a+="\x26"+Common.Util.checkEmpty("definition.principalKey",this.settings.definition.principalKey)+"\x3d"+c;a+="\x26"+Common.Util.checkEmpty("definition.refreshUrlKey",this.settings.definition.refreshUrlKey)+"\x3d"+d}"pagePanel"==b?a+="\x26agent\x3dy":"qrcodePanel"==b&&(a+="\x26agent\x3dn");return a};IAMCore.prototype._getApplyCaptchaUrl=function(a){var b=
new Map,c=encodeURIComponent(Common.Util.getEleValue("account.principalInput",a.settings.account.principalInput));b.set(Common.Util.checkEmpty("definition.principalKey",a.settings.definition.principalKey),c);b.set(Common.Util.checkEmpty("definition.umidTokenKey",a.settings.definition.umidTokenKey),a.runtime.umid.getValue());b.set(Common.Util.checkEmpty("definition.verifyTypeKey",a.settings.definition.verifyTypeKey),Common.Util.checkEmpty("captcha.use",a.settings.captcha.use));b.set(Common.Util.checkEmpty("definition.responseType",
a.settings.definition.responseType),Common.Util.checkEmpty("definition.responseTypeValue",a.settings.definition.responseTypeValue));b.set(Common.Util.checkEmpty("definition.secureAlgKey",a.settings.definition.secureAlgKey),a.runtime.handshake.handleChooseSecureAlg());c=a.getXsrfToken();b.set(c.paramName,c.value);c=a.generateReplayToken();b.set(c.paramName,c.value);a.runtime.handshake.handleSessionTo(b);b.set("r",Math.random());return Common.Util.checkEmpty("checkCaptcha.applyUri",a.runtime.safeCheck.checkCaptcha.applyUri)+
"?"+Common.Util.toUrl({},b)};IAMCore.prototype._getVerifyAnalysisUrl=function(a){var b=new Map,c=encodeURIComponent(Common.Util.getEleValue("account.principalInput",a.settings.account.principalInput));b.set(Common.Util.checkEmpty("definition.principalKey",a.settings.definition.principalKey),c);b.set(Common.Util.checkEmpty("definition.umidTokenKey",a.settings.definition.umidTokenKey),a.runtime.umid.getValue());b.set(Common.Util.checkEmpty("definition.verifyTypeKey",a.settings.definition.verifyTypeKey),
Common.Util.checkEmpty("captcha.use",a.settings.captcha.use));b.set(Common.Util.checkEmpty("definition.responseType",a.settings.definition.responseType),Common.Util.checkEmpty("definition.responseTypeValue",a.settings.definition.responseTypeValue));b.set(Common.Util.checkEmpty("definition.secureAlgKey",a.settings.definition.secureAlgKey),a.runtime.handshake.handleChooseSecureAlg());b.set("r",Math.random());c=a.getXsrfToken();b.set(c.paramName,c.value);c=a.generateReplayToken();b.set(c.paramName,c.value);
a.runtime.handshake.handleSessionTo(b);return Common.Util.checkEmpty("deploy.baseUri",a.settings.deploy.baseUri)+Common.Util.checkEmpty("definition.verifyAnalyzeUri",a.settings.definition.verifyAnalyzeUri)+"?"+Common.Util.toUrl({},b)};IAMCore.prototype._resetCaptcha=function(a){var b=this;a?(a=encodeURIComponent(Common.Util.getEleValue("account.principalInput",b.settings.account.principalInput,!1)),b._initSafeCheck(a,function(a){b.runtime.safeCheck.checkCaptcha.enabled&&!b.runtime.flags.isCurrentlyApplying&&
Common.Util.checkEmpty("captcha.getVerifier",b.settings.captcha.getVerifier)().captchaRender()})):Common.Util.checkEmpty("captcha.getVerifier",b.settings.captcha.getVerifier)().captchaRender()};IAMCore.prototype._snsViewReader=function(a,b){if("qrcodePanel"==b){var c=p.querySelector("#iam_qrcode_panel_iframe");if(null==c||0>=c.length){c=Common.Util.checkEmpty("sns.qrcodePanel",this.settings.sns.qrcodePanel);b=Common.Util.checkEmpty("qrcodePanel.src",c.src);var d=c.width||"250",e=c.height||"260",c=
p.createElement("iframe");c.setAttribute("id","iam_qrcode_panel_iframe");c.setAttribute("frameborder","1");c.setAttribute("scrolling","no");c.setAttribute("width",d);c.setAttribute("height",e);c.setAttribute("style","border:solid 0;");b.appendChild(c)}setTimeout(function(){var b=p.querySelector("#iam_qrcode_panel_iframe");-1==navigator.userAgent.indexOf("MSIE")?b.src=a:b.location=a},2)}else if("pagePanel"==b){b=Common.Util.checkEmpty("sns.pagePanel",this.settings.sns.pagePanel);var f=n.open(a,n,"modal\x3d"+
(b.modal||"yes")+",width\x3d"+(b.width||"800px")+",height\x3d"+(b.height||"500px")+",resizable\x3d"+(b.resizable||"no")+",left\x3d"+(b.left||"250px")+",top\x3d"+(b.top||"100px")),g=setInterval(function(){var a=n.document.getElementsByTagName("body")[0].getAttribute("refreshUrl");null!=f&&f.closed&&(clearInterval(g),Common.Util.isEmpty(a)||(Common.Util.getRootWindow(n).location.href=a))},200)}else throw"Unsupported panelType, use 'qrcodePanel' or 'pagePanel'";};IAMCore.prototype._initSNSAuthenticator=
...
"请完成人机验证":"Please complete man-machine verify");_resetCaptcha(!1);return}if(Common.Util.isAnyEmpty(b,d))a.settings.account.onError("No empty login name or password allowed");else if(a.settings.account.onBeforeSubmit(b,d,e)){$(Common.Util.checkEmpty("account.submitBtn",a.settings.account.submitBtn)).attr("disabled",!0);var g=new Map;g.set("{principalKey}",b);g.set("{credentialKey}",d);g.set("{clientSecretKey}",a.runtime.clientSecretKey.publicKeyHex);g.set("{clientRefKey}",a._getClientRef());g.set("{verifiedTokenKey}",
e);g.set("{verifyTypeKey}",Common.Util.checkEmpty("captcha.use",a.settings.captcha.use));g.set("{secureAlgKey}",a.runtime.handshake.handleChooseSecureAlg());g.set("{umidTokenKey}",a.runtime.umid.getValue());Common.Util.mergeMap(a.settings.account.customParamMap,g);a._doIamRequest("post","{accountSubmitUri}",g,function(c){$(Common.Util.checkEmpty("account.submitBtn",a.settings.account.submitBtn)).removeAttr("disabled");a.runtime.verifiedModel.verifiedToken="";var d=Common.Util.checkEmpty("definition.codeOkValue",
...
else{var c=$(Common.Util.checkEmpty("captcha.input",a.settings.captcha.input)),f=c.val();if(a.runtime.safeCheck.captchaEnabled&&(Common.Util.isEmpty(f)||f.length<c.attr("maxlength")))a.settings.account.onError("Illegal length of captcha input");else c=new Map,c.set("{principalKey}",encodeURIComponent(b)),c.set("{verifiedTokenKey}",f),a._doIamRequest("post","{smsApplyUri}",c,function(b){var c=Common.Util.checkEmpty("definition.codeOkValue",a.settings.definition.codeOkValue);if(Common.Util.isEmpty(b)||
...
!1)+Common.Util.getEleValue("sms.mobile",a.settings.sms.mobile,!1),c=Common.Util.getEleValue("sms.smsCode",a.settings.sms.smsCode,!1);if(a.settings.sms.onBeforeSubmit(b,c)){var f=new Map;f.set("{principalKey}",encodeURIComponent(b));f.set("{credentialKey}",c);f.set("{smsActionKey}",Common.Util.checkEmpty("definition.smsActionValueLogin",a.settings.definition.smsActionValueLogin));a._doIamRequest("post","{smsSubmitUri}",f,function(b){var c=Common.Util.checkEmpty("definition.codeOkValue",a.settings.definition.codeOkValue);
...
(e="Get verify code");d.text(e);clearInterval(c)}else d.attr("disabled",!0),d.text(b+"s"),b--},1E3)}}):IAMCore.Console.debug("SMS authenticator not enable!")};IAMCore.prototype._getClientRef=function(){var a=null,b=Common.Util.PlatformType,c;for(c in b)if(b[c]){IAMCore.Console.debug("Got current OS: "+c);a=c;break}Common.Util.isEmpty(a)&&(a="Unknown",console.warn("Unknown platform browser ["+navigator.appVersion+"]"));return a};IAMCore.prototype._doIamRequest=function(a,b,c,d,e,f,g){Common.Util.isMap(c)?
c.set("{responseType}",Common.Util.checkEmpty("definition.responseTypeValue",this.settings.definition.responseTypeValue)):Common.Util.isObject(c)&&(c.responseType=Common.Util.checkEmpty("definition.responseTypeValue",this.settings.definition.responseTypeValue));g&&this.runtime.handshake.handleSessionTo(c);g=null;b.startsWith("@")?g=b.substring(b.indexOf("@")+1):(g=Common.Util.checkEmpty("deploy.baseUri",this.settings.deploy.baseUri),b.startsWith("{")&&b.endsWith("}")&&(b=b.substr(1,b.length-2)),g+=
Common.Util.checkEmpty("definition",this.settings.definition[b]));b=new Map;if("POST"==a.toUpperCase()||"DELETE"==a.toUpperCase()){var k=this.getXsrfToken();b.set(k.headerName,k.value);k=this.generateReplayToken();b.set(k.headerName,k.value)}c=Common.Util.isMap(c)?Common.Util.toUrl(this.settings.definition,c):c;IAMCore.Console.debug("Requesting for - url:",g,"headers:",b);$.ajax({url:g,type:a,async:!0,headers:JSON.fromMap(b),data:c,xhrFields:{withCredentials:!0},success:function(a,b,c){d&&d(a)},error:function(a,
b,c){e&&e(c)},complete:function(a){f&&f(a)}})};IAMCore.prototype._checkAuthenticationAndRedirect=function(){var a=this;return{cache:{bodyStyle:null,bodyClass:null},hideDocumentAndOpenLoading:function(){var b=a._checkAuthenticationAndRedirect(),c=$("body");b.cache.bodyStyle=c.attr("style");b.cache.bodyClass=c.attr("class");c.removeAttr("style");c.removeAttr("class");0>=$(".iam_check_authc_redirect_style").length&&$("\x3cstyle class\x3d'iam_check_authc_redirect_style'\x3ediv,img,span,p,a,b{display:none;}body{background:url("+
a.settings.resources.loading+") no-repeat;background-position:center;!important}\x3c/style\x3e").appendTo($("head"))},showDocumentAndCloseLoading:function(){var b=a._checkAuthenticationAndRedirect(),c=$("body");b.cache.bodyStyle&&c.attr("style",b.cache.bodyStyle);b.cache.bodyClass&&c.attr("class",b.cache.bodyClass);$(".iam_check_authc_redirect_style").remove()},doHandle:function(b){IAMCore.Console.info("Checking unauthenticated and redirection ... ");var c=a._checkAuthenticationAndRedirect();c.hideDocumentAndOpenLoading();
$(function(){c.hideDocumentAndOpenLoading()});return new Promise(function(d){IAMCore.Console.info("Checking authentication state ...");a._initHandshakeIfNecessary(!0).then(function(e){if(a.checkRespUnauthenticated(e))IAMCore.Console.info("Unauthentication rendering login page ... "),setTimeout(function(){c.showDocumentAndCloseLoading();sessionStorage.removeItem(m.authRedirectRecordStorageKey);d(e)},200+parseInt(2E3*Math.random()));else{var f=JSON.parse(sessionStorage.getItem(m.authRedirectRecordStorageKey));
if(!f||f&&1E4<Math.abs((new Date).getTime()-f.t))sessionStorage.removeItem(m.authRedirectRecordStorageKey),f={c:0,t:(new Date).getTime()};if(10<f.c)throw"Too many failure redirections: "+f.c;++f.c;f.t=(new Date).getTime();sessionStorage.setItem(m.authRedirectRecordStorageKey,JSON.stringify(f));IAMCore.Console.info("Authenticated and redirection to: ",b);setTimeout(function(){n.location=b},200+parseInt(500*Math.random()))}})})}}};IAMCore.prototype._initHandshakeIfNecessary=function(a){var b=this;return this.runtime.umid.getValuePromise().then(function(c){return b.runtime.handshake.getValuePromise(c,
a)})};IAMCore.prototype.getUMToken=function(){return this.runtime.umid.getValue()};IAMCore.prototype.safeCheck=function(a,b,c){var d=this;this._initHandshakeIfNecessary(c).then(function(c){d._initSafeCheck(a,b)});return this};IAMCore.prototype.anyAuthenticators=function(){return this.accountAuthenticator().smsAuthenticator().snsAuthenticator().captchaVerifier()};IAMCore.prototype.accountAuthenticator=function(){this.settings.account.enable=!0;return this};IAMCore.prototype.smsAuthenticator=function(){this.settings.sms.enable=
!0;return this};IAMCore.prototype.snsAuthenticator=function(){this.settings.sns.enable=!0;return this};IAMCore.prototype.captchaVerifier=function(){this.settings.captcha.enable=!0;return this};IAMCore.prototype.bind=function(){var a=this;IAMCore.Console.info("IAMCore initializing binding ...");a._initHandshakeIfNecessary(!0).then(function(b){a._initAccountAuthenticator();a._initSMSAuthenticator();a._initSNSAuthenticator();a._initCaptchaVerifier()})};IAMCore.prototype.destroy=function(){for(var a in m)sessionStorage.removeItem(m[a]);
m=this.settings=this.runtime=this._defaultCaptchaVerifier=null;IAMCore.Console.log("Destroyed IAMCore instance.")};IAMCore.prototype.checkAuthenticationAndRedirect=function(a){return this._checkAuthenticationAndRedirect().doHandle(a)};IAMCore.prototype.multiModularMutexAuthenticatingHandler=function(a,b,c,d,e,f,g){return this._multiModularAuthenticatingHandler().doHandle(a,b,c,d,e,f,g)}})(window,document);