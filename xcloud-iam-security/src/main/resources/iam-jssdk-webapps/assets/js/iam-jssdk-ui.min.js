...
this;$(".iamjssdk-login-link").each(function(b,a){b=$(c).attr("data-panel");var f=$(a).attr("data-panel");b!=f?($("#"+f).hide(),$(a).removeClass("active")):($("#"+f).show(),$(a).addClass("active"))})});$(".code-close").click(function(){$(".code-write").hide()});$(".select-area").change(function(){"+086"!=$(this).children("option:selected").val()&&(alert("目前此功能仅对中国大陆用户开放！敬请谅解"),$(this).children("option")[0].selected=!0)})},k=function(c){var e={deploy:{defaultTwoDomain:"iam",defaultServerPort:14040,
defaultContextPath:"/iam-server"},init:{onPostCheck:function(a){a=(new IAMCore(c)).getIamBaseUri()+"/login/errread";$.ajax({url:a,xhrFields:{withCredentials:!0},success:function(a){a=a.data.errorTipsInfo;null!=a&&0<a.length&&$("#err_tip").text(a).show().delay(8E3).hide(100)}})},onError:function(a){console.error("初始化失败... "+a)}},captcha:{enable:!0,use:"VerifyWithJigsawGraph",panel:b.getElementById("iamjssdk_captcha_panel"),img:b.getElementById("iamjssdk_captcha_img"),input:b.getElementById("iamjssdk_captcha_input"),
onSuccess:function(a){console.debug("Captcha verify successful. verifiedToken is "+a)},onError:function(a){console.warn(a)}},account:{enable:!0,submitBtn:b.getElementById("iamjssdk_account_submit_btn"),principalInput:b.getElementById("iamjssdk_account_username"),credentialInput:b.getElementById("iamjssdk_account_password"),onBeforeSubmit:function(a,c,b){console.debug("Iam account login... principal: "+a+", plainPasswd: ******, captcha: "+b);return!0},onSuccess:function(a,b){console.debug("Iam account login successful !");
return!0},onError:function(a){console.error("Failed login. "+a);$("#err_tip").text(a).show().delay(5E3).hide(100)}},sms:{enable:!0,submitBtn:b.getElementById("iamjssdk_sms_submit_btn"),sendSmsBtn:b.getElementById("iamjssdk_sms_getcode_btn"),mobileArea:$(".select-area"),mobile:b.getElementById("iamjssdk_sms_user_phone"),smsCode:b.getElementById("iamjssdk_sms_code"),onBeforeSubmit:function(a,b){console.debug("Iam sms login ... mobileNum: "+a);return!0},onSuccess:function(a){$(".err-tip").text("");$(".code-write").hide()},
